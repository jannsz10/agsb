...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "jannsz10"         # 用户名
UUID = "b7c1ce8a-faa6-4ba5-b3c2-5068d5b9f3a3"                     # UUID，留空则自动生成
PORT = 25813                 # Vmess端口，留空或0则自动生成
DOMAIN = "st.cch.us.kg"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiZmE1MDBjNWQzNWNjM2FjYzRiNzBlNTdlNjE3MjU4MGMiLCJ0IjoiYTM0MmU4OWMtYmU0Ny00NTA2LTlkOTMtMWVhOWU1NGQ5ZDk5IiwicyI6IllqVXpOV00yTnpjdFl6TmxPUzAwTVRoakxXRmpOR1F0WXpNME5UYzFNamRpTW1VMCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
